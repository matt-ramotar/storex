 ...
 *
 * @see MutationStore For stores that support create/update/delete operations
...
internal class KeyMutex<Key>(private val maxSize: Int = 1000) {
    private val map = object : LinkedHashMap<Key, Mutex>(maxSize, 0.75f, true) {
        override fun removeEldestEntry(eldest: MutableMap.MutableEntry<Key, Mutex>?): Boolean {
            return size > maxSize
        }
    }
